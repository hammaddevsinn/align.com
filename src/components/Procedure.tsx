...
export default function Procedure() {
    return (
        <>
            <div className="procedure-style-0" bis_skin_checked="1">
                <div className="procedure-card-style-0" bis_skin_checked="1">

                    <div className="procedure-card-style-1" bis_skin_checked="1">

                        <svg className="procedure-card-style-2" fill="none" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 59 2">
                            <path d="M4 1h54" stroke="url(#a)" stroke-width="2" className="procedure-card-style-3"></path>
                            <path stroke="#99A9FF" stroke-width="2" d="M2 1H0" className="procedure-card-style-4"></path>
                            <defs className="procedure-card-style-5">
                                <linearGradient x1="58" y1="1" x2="4" y2="-.4" gradientUnits="userSpaceOnUse" className="procedure-card-style-6">
                                    <stop stop-color="#66FFE5" className="procedure-card-style-7"></stop>
                                    <stop offset="1" stop-color="#99A9FF" className="procedure-card-style-8"></stop>
                                </linearGradient>
                            </defs>
                        </svg>
                        <div className="procedure-card-style-9" bis_skin_checked="1">
                            <h4 className="procedure-card-style-10">Proven Success with Align's World-Class People, Process &amp; Tools</h4>
                        </div>
                    </div>
                    <div className="procedure-card-style-11" bis_skin_checked="1">

                        <div data-aos="fade-right" data-aos-delay="200" className="procedure-card-style-12" data-colname="Super Title" data-type="text" data-colsize="6" bis_skin_checked="1">
                            <div className="procedure-card-style-13" bis_skin_checked="1">

                                <div className="procedure-card-style-14" bis_skin_checked="1">
                                ...
                                <div className="procedure-card-style-20" bis_skin_checked="1">
                        ...
                        <div data-aos="fade-right" data-aos-delay="400" className="procedure-card-style-26" data-colname="Super Title" data-type="text" data-colsize="6" bis_skin_checked="1">
                            <div className="procedure-card-style-27" bis_skin_checked="1">
                                ...
                                <div className="procedure-card-style-34" bis_skin_checked="1">
                                    ...
                                    <a href="https://www.align.com/design-plan?hsLang=en" className="procedure-card-style-35">
                                        <span className="procedure-card-style-36">Learn More </span> <span className="procedure-card-style-37">
                                            <svg width="26" height="8" viewBox="0 0 26 8" fill="none" xmlns="http://www.w3.org/2000/svg" className="procedure-card-style-38">
                                                <path d="M25.155 5.14235C25.2978 4.99951 25.2978 4.76791 25.155 4.62506L22.8273 2.29739C22.6844 2.15455 22.4529 2.15455 22.31 2.29739C22.1672 2.44023 22.1672 2.67181 22.31 2.81465L24.3791 4.88371L22.31 6.95276C22.1672 7.09559 22.1672 7.32718 22.31 7.47002C22.4529 7.61286 22.6844 7.61286 22.8273 7.47002L25.155 5.14235ZM1 5.24947L24.8963 5.24947L24.8963 4.51795L1 4.51795L1 5.24947Z" fill="currentColor" stroke="currentColor" stroke-width="0.5" className="procedure-card-style-39"></path>
                                            </svg> </span> </a>
                                </div>
                            </div>
                        </div>
                        <div data-aos="fade-right" data-aos-delay="600" className="procedure-card-style-40" data-colname="Super Title" data-type="text" data-colsize="6" bis_skin_checked="1">
                            <div className="procedure-card-style-41" bis_skin_checked="1">

                                <div className="procedure-card-style-42" bis_skin_checked="1">
                                ...
                                <div className="procedure-card-style-48" bis_skin_checked="1">
                                    ...
                                    <a href="https://www.align.com/procure-build?hsLang=en" className="procedure-card-style-49">
                                        <span className="procedure-card-style-50">Learn More </span> <span className="procedure-card-style-51">
                                            <svg width="26" height="8" viewBox="0 0 26 8" fill="none" xmlns="http://www.w3.org/2000/svg" className="procedure-card-style-52">
                                                <path d="M25.155 5.14235C25.2978 4.99951 25.2978 4.76791 25.155 4.62506L22.8273 2.29739C22.6844 2.15455 22.4529 2.15455 22.31 2.29739C22.1672 2.44023 22.1672 2.67181 22.31 2.81465L24.3791 4.88371L22.31 6.95276C22.1672 7.09559 22.1672 7.32718 22.31 7.47002C22.4529 7.61286 22.6844 7.61286 22.8273 7.47002L25.155 5.14235ZM1 5.24947L24.8963 5.24947L24.8963 4.51795L1 4.51795L1 5.24947Z" fill="currentColor" stroke="currentColor" stroke-width="0.5" className="procedure-card-style-53"></path>
                                            </svg> </span> </a>
                                </div>
                            </div>
                        </div>
                        <div data-aos="fade-right" data-aos-delay="800" className="procedure-card-style-54" data-colname="Super Title" data-type="text" data-colsize="6" bis_skin_checked="1">
                            <div className="procedure-card-style-55" bis_skin_checked="1">

                                <div className="procedure-card-style-56" bis_skin_checked="1">
                                ...
                                <div className="procedure-card-style-62" bis_skin_checked="1">
                                    ...
                                    <a href="https://www.align.com/en-us/asset-point?hsLang=en" className="procedure-card-style-63">
                                        <span className="procedure-card-style-64">Learn More </span> <span className="procedure-card-style-65">
                                            <svg width="26" height="8" viewBox="0 0 26 8" fill="none" xmlns="http://www.w3.org/2000/svg" className="procedure-card-style-66">
                                                <path d="M25.155 5.14235C25.2978 4.99951 25.2978 4.76791 25.155 4.62506L22.8273 2.29739C22.6844 2.15455 22.4529 2.15455 22.31 2.29739C22.1672 2.44023 22.1672 2.67181 22.31 2.81465L24.3791 4.88371L22.31 6.95276C22.1672 7.09559 22.1672 7.32718 22.31 7.47002C22.4529 7.61286 22.6844 7.61286 22.8273 7.47002L25.155 5.14235ZM1 5.24947L24.8963 5.24947L24.8963 4.51795L1 4.51795L1 5.24947Z" fill="currentColor" stroke="currentColor" stroke-width="0.5" className="procedure-card-style-67"></path>
                                            </svg> </span> </a>
                                </div>
                            </div>
                        </div>
