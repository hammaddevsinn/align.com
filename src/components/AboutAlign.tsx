...
export default function AboutAlign() {
    ...
    return (
        <>
            <div className="about-align-style-0" bis_skin_checked="1">
                <div className="about-section-style-0" bis_skin_checked="1">
                    <div className="about-section-style-1" bis_skin_checked="1">
                        <div ref={textRef} data-aos="fade-right" data-aos-delay="200" className="about-section-style-2" data-colname="" data-type="text" data-colsize="6" bis_skin_checked="1">
                            <div className="about-section-style-3" bis_skin_checked="1">
                                <div className="about-section-style-4" bis_skin_checked="1">
                                    <div className="about-section-style-5" bis_skin_checked="1">
                                        About Align
                                    </div>
                                    ...
                                    <div className="about-section-style-8" bis_skin_checked="1">
                            ...
                            <div className="about-section-style-11" bis_skin_checked="1">
                                <a href="https://www.align.com/about?hsLang=en" className="about-section-style-12">About Align</a>
                            </div>
                        </div>
                        <div ref={animationRef} data-aos="fade" data-aos-delay="400" className="about-section-style-13" data-colname="" data-type="lottie" data-colsize="6" bis_skin_checked="1">
                            <div className="about-section-style-14" bis_skin_checked="1">
                                <Player
                                    autoplay
                                    loop
