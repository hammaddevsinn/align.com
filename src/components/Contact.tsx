...
export default function Contact() {
    return (
        <>
            <div className="contact-style-0" bis_skin_checked="1">
                <video className="contact-bg-video" autoPlay muted loop playsInline>
                    <source src="/videos/contact.mp4" type="video/mp4" />
                </video>
                <div className="contact-arrow-style-0" bis_skin_checked="1">
                ...
                <div className="contact-form-style-0" bis_skin_checked="1">
                    <div className="contact-form-style-1" bis_skin_checked="1">
                        <div className="contact-form-style-2" data-aos="fade" bis_skin_checked="1">
                            <div className="contact-form-style-3" bis_skin_checked="1">
                        ...
                        <div className="contact-form-style-22" bis_skin_checked="1">
                            <div className="contact-form-style-23" bis_skin_checked="1">
                            ...
                            <div className="contact-form-style-27" bis_skin_checked="1" data-hs-forms-root="true">
                                <form method="POST" accept-charset="UTF-8" enctype="multipart/form-data" novalidate="" action="https://forms.hsforms.com/submissions/v3/public/submit/formsnext/multipart/3343341/20b42b85-ddea-43d0-8e4f-27113f478926" className="contact-form-style-28" target="target_iframe_20b42b85-ddea-43d0-8e4f-27113f478926" data-instance-id="853389ab-673a-430f-9acc-8cf84069384a" data-form-id="20b42b85-ddea-43d0-8e4f-27113f478926" data-portal-id="3343341" data-test-id="hsForm_20b42b85-ddea-43d0-8e4f-27113f478926">
                                    <div className="contact-form-style-29" bis_skin_checked="1"><label className="contact-form-style-30" for="firstname-20b42b85-ddea-43d0-8e4f-27113f478926"><span className="contact-form-style-31">First Name</span><span className="contact-form-style-32">*</span></label>
                                        <div className="contact-form-style-33" bis_skin_checked="1"><input name="firstname" required="" placeholder="" type="text" className="contact-form-style-34" inputmode="text" autocomplete="given-name" value="" /></div>
                                    </div>
                                    <div className="contact-form-style-35" bis_skin_checked="1"><label className="contact-form-style-36" for="lastname-20b42b85-ddea-43d0-8e4f-27113f478926"><span className="contact-form-style-37">Last Name</span><span className="contact-form-style-38">*</span></label>
                                        <div className="contact-form-style-39" bis_skin_checked="1"><input name="lastname" required="" placeholder="" type="text" className="contact-form-style-40" inputmode="text" autocomplete="family-name" value="" /></div>
                                    </div>
                                    <div className="contact-form-style-41" bis_skin_checked="1"><label className="contact-form-style-42" for="email-20b42b85-ddea-43d0-8e4f-27113f478926"><span className="contact-form-style-43">Email</span><span className="contact-form-style-44">*</span></label>
                                        <div className="contact-form-style-45" bis_skin_checked="1"><input name="email" required="" placeholder="" type="email" className="contact-form-style-46" inputmode="email" autocomplete="email" value="" /></div>
                                    </div>
                                    <div className="contact-form-style-47" bis_skin_checked="1">
                                        <div className="contact-form-style-48" bis_skin_checked="1"><label className="contact-form-style-49" for="w_a-20b42b85-ddea-43d0-8e4f-27113f478926"><span className="contact-form-style-50">Service</span><span className="contact-form-style-51">*</span></label>
                                            <div className="contact-form-style-52" bis_skin_checked="1"><select required="" className="contact-form-style-53" name="w_a">
                                                <option disabled="" value="" className="contact-form-style-54">Please Select</option>
                                    ...
                                    <div className="contact-form-style-61" bis_skin_checked="1"><label className="contact-form-style-62" for="please_provide_any_additional_information__comments__or_requests_-20b42b85-ddea-43d0-8e4f-27113f478926"><span className="contact-form-style-63">Please provide any additional information, comments, or requests:</span></label>
                                        <div className="contact-form-style-64" bis_skin_checked="1"><textarea className="contact-form-style-65" name="please_provide_any_additional_information__comments__or_requests_" placeholder=""></textarea></div>
                                    </div>
                                    <div className="contact-form-style-66" bis_skin_checked="1">
                                        <div className="contact-form-style-67" bis_skin_checked="1"></div>
                                        <div className="contact-form-style-68" bis_skin_checked="1"><input type="submit" className="contact-form-style-69" value="Contact Us" /></div>
