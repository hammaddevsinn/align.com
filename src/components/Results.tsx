          ...
          <div className="flex flex-row gap-[3.3333%] max-md:flex-col max-md:gap-10">
            ...
            >
              ...
              <a
                ...
                className="inline-block rounded-md bg-gradient-to-r from-[#008AD4] to-[#00D1FF] px-6 py-4 text-center text-[18px] font-bold leading-[18px] text-[#141414] shadow-[0_3px_9px_rgba(20,20,20,0.25)] transition-all duration-300 hover:shadow-lg"
              >
